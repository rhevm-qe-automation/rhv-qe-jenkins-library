...
def call(Map config = [:]) {
    ...
    sh "rm -rf rhevm-qe-infra \
        && git clone https://code.engineering.redhat.com/gerrit/rhevm-qe-automation/rhevm-qe-infra \
        && cd rhevm-qe-infra \
        && git fetch https://code.engineering.redhat.com/gerrit/rhevm-qe-infra ${cherry_pick} \
